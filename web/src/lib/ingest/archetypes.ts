...
export const ARCHETYPES: ArchetypeDefinition[] = [
  ...
  {
    id: "classify-rows-in-table",
    label: "Classify each row of a table by choosing from a fixed set",
    rendererType: "table_dropdown",
    stimulusType: "none",
    typicalMarks: [2, 3],
    commandVerbs: ["select", "choose", "identify"],
    cognitiveDemand: "application",
    multipart: false,
    transformationPattern: "situation → category",
    markingStructure: "proportion of dropdown cells correct",
    topicSuitability: ["ssa", "pwa", "auto", "proj"],
    signals: [
      "choose the most appropriate",
      "select the correct entries to complete",
      "match each",
      "indicate whether",
    ],
  },
